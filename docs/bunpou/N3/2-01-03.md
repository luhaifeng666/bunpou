...
# <grammer-content sentence='V[方/かた]＜方法＞' inline /> <Badge type="warning" text="N3" />

- 意义：表示行为、动作的方式、方法；
- 接续：
  - [动词的第一连用形](../../verb.md#_2-动词第一连用形的常见用法) + 方；
  - <grammer-content sentence="三类动词比较特殊，接续方式为：**词干 + の + [仕方/しかた]**" inline />
- 译文：...法；...的方法；
