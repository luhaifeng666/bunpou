...
<grammer-content sentence="**一类形容词** 的词尾为 **「い」**： **<u>[面白/おもし](词干) + い(词尾)</u>**。" />
<grammer-content sentence="**二类形容词** 的词尾为 **「だ」**， 但是**一般会省略**，只有当**以二类形容词结句（即二类形容词放在句尾）时**，需要加上 「だ」。如果使用的是敬体形式，则不需要加 「だ」，而是以 **「です」** 结句。： **<u>[綺麗/きれい](词干) + (だ)(词尾, 省略)</u>**。" />
