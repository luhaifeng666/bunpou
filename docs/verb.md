...
1. <grammer-content sentence="[３日/みっか][間/かん]で[荷物/にもつ]が **<del>[届/とど]ける❌</del>／[届/とど]く**。" trans="货物3日内能到。" />
2. <grammer-content sentence="[会議/かいぎ]は９[時/じ]に **<del>[始/はじ]まれる❌</del>／[始/はじ]まる**。" trans="会议9点能开始。" />
...
1. [Ⅴてくれる: 对方为己方做某事；他方为他方做某事](./bunpou/course14/2-03-07.md)
2. [Ⅴてあげる: 己方为对方做某事](./bunpou/course14/2-03-08.md)
3. [Ⅴてもらう: 己方拜托对方为己方做某事](./bunpou/course14/2-03-09.md)

::: danger :warning: 注意：

只有存在受益关系时，即 `己方收益，或他方收益` 的情况下，才可以使用动词的受益态！！
...
* 意义：表示如果该条件 （动作 、变化 、状态 、性质等 ）成立 ,就会出现后面的结果。也叫做动词的 `假定性` 或 `ば` 形；
* 译文：如果……就……; 假如……要是……

::: danger :warning: 注意

`「ば」` 为 `动词` 和 [形容词](./adjective.md#形容词的条件形) 的 `条件形之一`, 二者的`活用方式不同` 。

:::

| 动词类别 |                                条件形变形规律                                |                                                  例子                                                   |
| :------: | :--------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: |
| 一类动词 |        <grammer-content sentence="词尾**う**段变**え** + **ば**" />        |   <grammer-content sentence="[買/か]**う** -> [買/か]**えば**" />   |
| 二类动词 |            <grammer-content sentence="去**词尾る** + **れば**" />            | <grammer-content sentence="[見/み]**る** -> [見/み]**れば**" /> |
| 三类动词 | <grammer-content sentence="**[来/く]る -> [来/く]れば　/　する -> すれば**" /> |         <grammer-content sentence="[勉強/べんきょう]**する** -> [勉強/べんきょう]**すれば**" />         |

::: info :books: 例句

1. <grammer-content sentence='[困った/こまった]ことが**あれば**、[友達/ともだち]に[教え/おしえ]てもらうから、[大丈夫/だいじょうぶ]よ。' trans='如果有困难的话，可以请教朋友，所以没问题的。' />
2. <grammer-content sentence='[雨/あめ]が**[降れ/ふれ]ば**、[出かけ/てかけ]ない。' trans='如果下雨的话，就不出门。' />
3. <grammer-content sentence='[毎日/まいにち]よく**[練習/れんしゅう]すれば**、きっと[上手/じょうず]になる。' trans='只要每天好好练习，一定会进步的。' />

:::

::: tip :bookmark: 补充

1. 动词的否定形 「V ない」变为条件形时,要按照 `形容词条件形` 的变化规则变化 , 即将 `「Vない」` 变 为 `「Vなければ」`：

<div class="bunpou-block">

<grammer-content sentence='[日本語/にほんご]が**わからなければ**、 [日本/にほん]の[漫画/まんが]のおもしろさがわからない。' trans='如果不懂日语，就无法体会日本漫画的有趣之处。' />

</div>

2. 「ば」条件形有时蕴含着 `建议对方进行某动作的含义`, 在 `「〜なければ、〜ない」` 这样的双重否定句式中尤为如此。例如下面的例句实际上说话人是要表示 `把话说明白` 的意思：

<div class="bunpou-block">

<grammer-content sentence='はっきり**[言わ/いわ]なければ**、[自分/じぶん]の[気持ち/きもち]を[人/ひと]にわかってもらえない。' trans='如果不说清楚，别人就无法理解你的感受。' />
